...
function App() {
  ...
  const handleToast=()=>toast.custom((t) => (
  <div
    className={`${
  ...
  return (
    <QueryClientProvider client={client}>
     ...
     {/* <UserListFetch/> */}
     {/* <Pokedex/> */}
     {/* <h1 className='text-3xl bg-amber-900 border-8 border-amber-300'>
      Hola 
     </h1> */}
     {/* <Tail/> */}

     <Title>8‑Bit Title</Title>
     <Title size="lg" variant="secondary">Status</Title>
